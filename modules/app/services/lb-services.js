...
/**
 * @ngdoc object
 * @name lbServices.BaseNews
 * @header lbServices.BaseNews
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `BaseNews` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.BaseNews#create
         * @methodOf lbServices.BaseNews
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `BaseNews` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/BaseNews",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.BaseNews#upsert
         * @methodOf lbServices.BaseNews
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.BaseNews#exists
         * @methodOf lbServices.BaseNews
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/BaseNews/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.BaseNews#findById
         * @methodOf lbServices.BaseNews
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/BaseNews/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.BaseNews#find
         * @methodOf lbServices.BaseNews
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.BaseNews#findOne
         * @methodOf lbServices.BaseNews
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/BaseNews/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.BaseNews#updateAll
         * @methodOf lbServices.BaseNews
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/BaseNews/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.BaseNews#deleteById
         * @methodOf lbServices.BaseNews
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.BaseNews#count
         * @methodOf lbServices.BaseNews
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/BaseNews/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.BaseNews#prototype$updateAttributes
         * @methodOf lbServices.BaseNews
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.BaseNews#updateOrCreate
         * @methodOf lbServices.BaseNews
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.BaseNews#update
         * @methodOf lbServices.BaseNews
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.BaseNews#destroyById
         * @methodOf lbServices.BaseNews
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.BaseNews#removeById
         * @methodOf lbServices.BaseNews
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.BaseNews#modelName
    * @propertyOf lbServices.BaseNews
    * @description
    * The name of the model represented by this $resource,
    * i.e. `BaseNews`.
    */
    R.modelName = "BaseNews";
